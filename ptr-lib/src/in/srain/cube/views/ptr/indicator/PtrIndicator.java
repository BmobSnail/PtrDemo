...
public class PtrIndicator {
    ...
    public void setRatioOfHeaderHeightToRefresh(float ratio) {
        Log.i("ptr-->","setRatioOfHeaderHeightToRefresh,ratio="+ratio);
        Log.i("ptr-->","setRatioOfHeaderHeightToRefresh,mHeaderHeight="+mHeaderHeight);
...
//        return mOffsetToRefresh;
    ...
    public void convertFrom(PtrIndicator ptrSlider) {
        ...
        Log.i("ptr-->","convertFrom="+ptrSlider.mHeaderHeight);
    }
