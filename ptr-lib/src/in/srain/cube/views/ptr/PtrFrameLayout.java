...
public class PtrFrameLayout extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPreventForHorizontal || (mHasBanner && xDiff > mPagingTouchSlop / 2 && e.getY() < getResources().getDisplayMetrics().scaledDensity * 150)) {
                    return dispatchTouchEventSupper(e);
                }
    ...
    protected void setHasBanner(boolean mHasBanner) {
        this.mHasBanner = mHasBanner;
    }
}
